...
val BranchOffScene = state(Interaction) {
    ...
    onResponse<GoStraight> {
        ...
        furhat.say("As you walk down the corridor, you more words written on the corridor's walls and ceiling.")
        ...
        if (turnAround == true) {
            ...
            delay(300)
            furhat.say("Shortly after you started running, the walls crush you and you die.")
...
private val dialogStrings = mapOf(
    ...
    "onArrival2" to
            "You notice that it gets colder as you continue to walk down the tunnel and water is dripping down from the corridor's ceiling from time to time.",
    "onArrival3" to
    ...
    "onArrival4" to
            "On the ceiling you can see the words \"Find us where the dawn is rising\" written.",
    "onArrival5" to
